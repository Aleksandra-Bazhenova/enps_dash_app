# general_project_template guide installation
...
activate general_project_template
```
...
To move beyond notebook prototyping, all reusable code should go into the `module_name/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `module_name` folder and use the modules inside your notebooks :
